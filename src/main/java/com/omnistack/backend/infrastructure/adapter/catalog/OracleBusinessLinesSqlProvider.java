...
public class OracleBusinessLinesSqlProvider {
    ...
    private final String adCapabilitiesByProviderSql = readSql("sql/business-lines/oracle/ad-capabilities-by-provider.sql");
    ...
    public String getAdCapabilitiesByProviderSql() {
        return adCapabilitiesByProviderSql;
    }
